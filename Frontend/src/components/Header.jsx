  ...
  return (
    <header className="sticky top-0 z-[100] border-b border-slate-200/80 bg-white/75 backdrop-blur-xl backdrop-saturate-150">
      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-5xl h-[60px] flex items-center justify-center gap-6">

          {/* Logo */}
          <button
            onClick={onReset}
            className="flex items-center gap-2.5 bg-transparent border-0 p-0 cursor-pointer shrink-0 group"
          >
            ...
            <div>
              <div className="font-display font-bold text-[14px] text-slate-900 leading-none tracking-[-0.02em] group-hover:text-blue-700 transition-colors">
                GeneAtlas
              </div>
              <div className="font-mono text-[8px] text-slate-400 tracking-[0.14em] mt-0.5">
          ...
          <div className="hidden lg:flex items-center gap-1.5 shrink-0">
            <span className="font-mono text-[9px] text-slate-400 mr-1 tracking-[0.1em]">
              QUICK
            </span>
